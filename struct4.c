...
void main()
{
     ...
     for(count=0;count<3;count++)
     {
          ...
          gets(country[count].name);
     }
     for(count=0;count<3;count++)
     {
          printf("\nthe time of country %d is hours : %d minutes.seconds : %.2f first letter : %s",count+1,country[count].hours, country[count].minutes_second, country[count].name);
     }
}